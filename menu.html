  ...
  <div class="container menu pt-3 mb-4">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/bryndzove-halusky.jpg" alt="Bryndzové Halušky" class="img-fluid mb-3" onclick="toggleText('bryndzove-halusky')">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/kapustnica.jpg" alt="Kapustnica" class="img-fluid mb-3" onclick="toggleText('kapustnica')">
          <h3>Kapustnica</h3>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/svieckova-na-smotane.jpg" alt="Sviečková na smotane" class="img-fluid mb-3" onclick="toggleText('svieckova-na-smotane')">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/pirohy.jpg" alt="Pirohy" class="img-fluid mb-3" onclick="toggleText('pirohy')">
          <h3>Pirohy</h3>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/zivanska.jpg" alt="Živánska" class="img-fluid mb-3" onclick="toggleText('zivanska')">
          <h3>Živánska</h3>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="food-item">
          <img src="img/rezen.jpg" alt="Rezeň" class="img-fluid mb-3" onclick="toggleText('rezen')">
          <h3>Rezeň</h3>
